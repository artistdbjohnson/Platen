// LARKSPUR · by douglxss · github.com/artistdbjohnson/Larkspur
// ── CORE DATA & CONFIG ────────────────────────────────────────────────────────
...
var PALETTES = {
    ...
    seigaiha: [  // The Sea & Waves
        ...
        { c: "#FFFFFF", r: 1, v: 1 }  // Pure White (Larkspur foam accent)
    ],
...
var MOTIF_OPTS = ['random', 'ichthus', 'larkspur', 'quatrefoil', 'tatreez', 'viana_heart'];
var CHROME_OPTS = ['random', 'adama', 'adire', 'aizome', 'alentejo', 'azulejo_classico', 'barzel', 'bedouin_night', 'bleached', 'blueprint_cyan', 'bogolan', 'bricolage', 'burntwater', 'cherokee', 'chinle', 'collage', 'concrete', 'crystal', 'cyber_mesh', 'flow', 'flow_deep', 'gan', 'ganado', 'gaza_dusk', 'glitch_acid', 'glitch_heat', 'glitch_void', 'kabuki', 'kagetoh', 'kakiishibu', 'karkom', 'kaspi', 'katan', 'kente', 'kinjiki', 'kinpak', 'kokkos', 'kuba', 'lissitzky', 'manueline', 'matcha', 'matsuri', 'minho', 'moki', 'mondrian', 'murex', 'nana', 'navajo', 'negev_gold', 'olive_grove', 'orak', 'palestine_dawn', 'panar', 'pepel', 'pombalino', 'porphyra', 'rodchenko', 'rutsya', 'sakura', 'savonnerie', 'seigaiha', 'shahar', 'shibui', 'shiprock', 'shoshan', 'sintra', 'spectrum', 'stolz', 'structural', 'sumi', 'suprematism', 'tarshish', 'teec_nos_pos', 'tekhelet', 'tukmo', 'two_grey_hills', 'uguisu', 'ukiyoe', 'verena', 'viride', 'wari', 'woodcut', 'yam', 'zahav'];

var ENGINE_OPTS = ['random', 'adama', 'adire', 'argyle', 'arraiolos', 'art_deco', 'asanoha', 'axonometric', 'azulejo', 'blueprint', 'bogolan', 'bricolage', 'brutalist', 'castelo_branco', 'cherokee', 'chiefs', 'chipaz', 'circuit', 'collage', 'cubist', 'current', 'cyber_mesh', 'cypress_hills', 'dazzler', 'flow', 'flowing_contours', 'flowing_streams', 'framed_vista', 'fret_bands', 'glitch', 'interlace', 'kagome', 'kanzemizu', 'kente', 'kepe', 'kikkou', 'kishtima', 'kolya', 'kshtir', 'kuba', 'kudo', 'malevich', 'mastor', 'matsukawa', 'metropolis', 'mondrian', 'narmuny', 'navajo', 'optical_box', 'orak', 'pakshats', 'panoramic_dunes', 'panks', 'pre_columbian', 'pulay', 'rolling_hills', 'seigaiha', 'serape_net', 'sermat', 'sermat-kudo', 'shippo', 'shiprock', 'sierra_sunset', 'spider_cross', 'stolz', 'structural', 'tangents', 'tol', 'ved', 'verena', 'viana', 'virma', 'wari', 'woodcut', 'yagasuri', 'yoshiwara'];

var CANVAS_OPTS = ['black', 'tan', 'olive', 'white'];

var MOTIF_DESCS = {
    'ichthus': 'Christian Ichthus (\u2638)',
    'larkspur': 'Classic 3-Petal Larkspur',
    'quatrefoil': '4-Petal Quatrefoil (\uA564)',
    'tatreez': 'Tatreez Cross-Stitch (\u271A)',
    'viana_heart': 'Viana Heart (\u2764)'
};

var MOTIF_PATHS = {
    'ichthus': 'M19.370 7.130C17.927 10.077 14.599 12.874 10.900 13.817 7.218 14.755 3.257 13.880 0.474 9.740L0.000 10.000c5.900 8.600 16.810 4.626 19.900 -2.295z M19.370 12.870C17.927 9.923 14.599 7.126 10.900 6.183 7.218 5.245 3.257 6.120 0.474 10.260L0.000 10.000c5.900 -8.600 16.810 -4.626 19.900 2.295z',
    'larkspur': 'M 100,5 C 215,90 270,225 185,275 C 95,315 15,225 80,115 C 50,220 15,325 100,385 C 190,445 285,385 240,290 C 275,370 295,455 210,480 C 120,500 45,430 70,335 C 20,410 10,480 80,515 C 165,560 250,500 220,410 C 240,490 240,555 160,570 C 80,580 -25,485 10,385 C 45,280 -60,180 -5,80 C 50,-10 135,-35 100,5 Z',
...
var CHROME_DESCS = {
    ...
    'negev_gold': 'Negev Sands / Desert Bold',
    'neshef': 'Low-Key',
    'olive_grove': 'Olive Grove (Heavy Greens / Pale Sky)',
    'orak': 'Spectral Observation',
    'palestine_dawn': 'Palestine Dawn (Soft Pink / Crimson / Indigo)',
...
var ENGINE_DESCS = {
    ...
    'flowing_streams': 'Flowing Streams',
    ...
    'matsukawa': 'Japanese Matsukawa-bishi (Pine Bark)',
