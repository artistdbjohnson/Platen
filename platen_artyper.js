...
function generatePatternParams(eng,prng,w,h){
  ...
  switch(eng){
    ...
    default:
      ...
      // block
      else if(['brutalist','malevich'].indexOf(eng)>=0){P.rects=[];for(var bri2=0;bri2<ri(4,10);bri2++){P.rects.push({x:mfloor(w*rf()),y:mfloor(h*rf()),w:ri(5,mfloor(w*0.4)),h:ri(5,mfloor(h*0.4)),wt:rf(4,12)});}}
      // current/chief
...
function setup() {
  ...
  css.textContent = [
    ...
    'border:1px solid #3a3835;padding:5px 4px;font:11px "Courier New";border-radius:2px;outline:none;appearance:auto;}',
    '#panel select option{background:#1a1816;color:#c8c0b4;}',
